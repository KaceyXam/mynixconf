...
# exit
bind=SUPER,m,spawn,qs -c noctalia-shell ipc call sessionMenu toggle
bind=SUPER+SHIFT,q,killclient,
bind=SUPER+SHIFT,l,spawn,qs -c noctalia-shell ipc call lockScreen lock
...
bind=SUPER,d,set_proportion,0.8
bind=SUPER,c,set_proportion,0.5
...
bind=SUPER+CTRL+Alt,1,toggletag,1,0
bind=SUPER+CTRL+Alt,2,toggletag,2,0
bind=SUPER+CTRL+Alt,3,toggletag,3,0
bind=SUPER+CTRL+Alt,4,toggletag,4,0
bind=SUPER+CTRL+Alt,5,toggletag,5,0
bind=SUPER+CTRL+Alt,6,toggletag,6,0
bind=SUPER+CTRL+Alt,7,toggletag,7,0
bind=SUPER+CTRL+Alt,8,toggletag,8,0
bind=SUPER+CTRL+Alt,9,toggletag,9,0
...
tagrule=id:1,monitor_name:^DP-2$,layout_name:tgmix
tagrule=id:1,monitor_name:^DP-3$,layout_name:tgmix
...
source-optional = /home/kxkniffen/.config/mango/noctalia.conf
        '';
        autostart_sh = ''
          ${noctalia}
        '';
